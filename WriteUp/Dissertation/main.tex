...
\textbf{Offset} &  &  &  &  \\ 
\hline
\textbf{0} & length & packetType & sender & destination \\ 
\hline
...
% Introduce and typeset the data structure to transfer information between the two threads 
...
My implementation of Epidemic routing is broadly similar, but 
