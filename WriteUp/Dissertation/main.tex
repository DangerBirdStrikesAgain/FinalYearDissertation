...
When debugging more persistent issues, such as the MicroPython-CircuitPython communication, my supervisor kindly lent me a logic analyser. Figure 3.12 shows the a node being analysed. \\ \\ 
\begin{figure}[h]
\begin{center}
...
%TODO Debugging when connected to an external power source was actually awful I have never hated antthing so much 
...
Where $\phi$ is the latitude and $\lambda$ is the longitude and $haversine(\theta)$ is abbreviated to $hav(\theta)$. \\
